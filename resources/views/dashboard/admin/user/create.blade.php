            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="formTambahUser" method="POST" action="{{ route('dashboard.users.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <!-- Nama User -->
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="umur" name="umur" placeholder="Masukkan umur user" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="alamat" name="alamat" placeholder="Masukkan alamat user" required></textarea>
                                        </div>
                                    </div>
...
@include('includes.admin.myScripts.user.createScript')
